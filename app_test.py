...
#         documents = request.files.getlist("documents")
#         signals_docs = request.files.getlist("signals")
#         interviews = request.files.getlist("interviews")
...
#         # Additional signals documents
#         for f in signals_docs:
#             try:
#                 wrapper = FlaskFileWrapper(f)
#                 wrapper.seek(0)
#                 text = processor.extract_text_from_file(wrapper)
...
#                 except Exception as exc:
#                     text = f"Could not read {f.filename}: {exc}"
#                 all_text += f"\n\n--- FULL INTERVIEW DATA ({f.filename}) ---\n" + (text or "") + "\n\n"
...
#         # Mixed payload: optional files + JSON fields
#         domain = request.form.get("domain", "").strip()
#         if not domain:
#             return jsonify({"error": "Missing domain"}), 400
...
#21-08-2025
#updated the strong ,week signal , steepv analysis, future triangle because we added the extract_comprehensive_text function in main.py
...
#22-08-2025
#Added new function def save_steepv and def save_futures_triangle for the editable method in steepv and future triangle and save that for future
...
# #22-08-2025
# #added def save_phase1_progress() for save button in phase 1 
...
#25-08-2025
#added def generate_futures_triangle_2_0(): for phase 3
...
#25-08-2025
#added  def generate_baseline_scenario(): for the phase 3
...
#25-08-2025
#added  def generate_driver_outcomes(): for phase 3
...
#26-08-2025
#added def generate_alternative_scenarios for Alternative Scenarios in phase 3
...
#01-09-2025
#added def generate_mindmap() for the mind map visualization --- what to check it was needed?
#yes it was needed.....
...
#added def translate_domain_map()
...
#         if result.get("auto_translated"):
#             return jsonify({
#                 "domain_map": result["domain_map"],
#                 "source_language": result["source_language"],
#                 "auto_translated": True,
#                 "message": "Document was in Lao - automatically translated to Lao"
#             })
#         else:
#             return jsonify({
#                 "domain_map": result.get("domain_map", result),
...
#     @app.route("/api/translate-domain-map", methods=["POST"])
#     def translate_domain_map():
#         if processor is None:
...
#                 translated_map = processor.translate_to_lao(domain_map)
#             else:
#                 translated_map = processor.translate_to_english(domain_map)
                
#             return jsonify({
#                 "translated_domain_map": translated_map,
...
#23-09-2025
#added  def wind_tunnel_analysis() for visioning phase 4
...
#30-09-2025
#testing with language translation using free and google api
